...
setup(
    name='sopel_modules.gif',
    version='0.1.0',
    description='Sopel Gif Search builds a convenient framework for searching for Gifs',
    long_description=readme + '\n\n' + history,
    author='Sam Zick',
    author_email='sam@deathbybandaid.net',
    url='https://github.com/deathbybandaid/Sopel-GifSearch',
